...
/**
 * Here we verify that our client can receive any kind of
...
public class StatusCodesTest {
     ...
     * Method: GET
     *
     * Here we verify that the proxy did not change
     * or block the method incoming method and will
     * allow it to return the expected status code
     */
